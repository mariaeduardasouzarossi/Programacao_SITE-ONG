export const templates = {
  inicio: `
    <section class="banner-home">
      ...
      <p>Conheça o Projeto Viva ONG e <a href="#" data-page="cadastro" class="banner-btn" tabindex="0">junte-se à missão!</a></p>
    </section>
    ...
    <section class="noticias">
      ...
      <div class="card-list">
        ...
        <div class="card" tabindex="0">
          ...
          <p>Inaugurada nossa primeira horta com a ajuda de voluntários.</p>
        </div>
      </div>
    </section>
    <section class="chamada-voluntario" tabindex="0">
      <h2>Seja um voluntário</h2>
      <p>Participe, traga suas ideias e habilidades e faça parte deste movimento de transformação!</p>
      <a href="#" data-page="cadastro" class="btn-voluntario" tabindex="0">Quero ser voluntário</a>
    </section>
  `,
  projeto: `
    <section class="chamada-voluntario" tabindex="0">
    ...
    <section class="card-grid">
      <div class="card-flip" data-category="social" tabindex="0" aria-label="Refazer Sorrisos, andamento">
      ...
      <div class="card-flip" data-category="ambiental" tabindex="0" aria-label="Paisagismo Solidário, concluído">
        <div class="card-front">
          <span class="projeto-icone">🌳</span>
  ...
  cadastro: `
    <section class="cadastro-container">
      <div class="cadastro-banner">
        <img src="logo.png" alt="Logo Projeto Viva ONG" class="logo-banner-grande">
        <h2>Junte-se ao Projeto Viva ONG</h2>
        <p>Contribua para transformar vidas e o futuro da sua comunidade!</p>
      </div>
      <form class="cadastro-form" aria-label="formulário de cadastro">
        ...
        <textarea name="interesses" placeholder="Descreva como pode colaborar, habilidades, horários, etc." required></textarea>
